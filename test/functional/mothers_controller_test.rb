...
class MothersControllerTest < ActionController::TestCase
  ...
  test "should create mother" do
    assert_difference('Mother.count') do
      post :create, mother: { age: @mother.age, job: @mother.job, name: @mother.name, surname: @mother.surname }
    end
  ...
  test "should update mother" do
    put :update, id: @mother, mother: { age: @mother.age, job: @mother.job, name: @mother.name, surname: @mother.surname }
    assert_redirected_to mother_path(assigns(:mother))
  end
